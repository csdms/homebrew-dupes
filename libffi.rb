...
class Libffi < Formula
  ...
  def install
    ...
    inreplace lib+'pkgconfig/libffi.pc' do |s|
      s.gsub! 'libdir=${exec_prefix}/lib',
              'libdir=${exec_prefix}/lib64'
      s.gsub! 'includedir=${libdir}/libffi-3.0.13/include',
              'includedir=${exec_prefix}/lib/libffi-3.0.13/include'
    end unless OS.mac?
  end
